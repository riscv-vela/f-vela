...
// yookyung_generate
object ReadsScalar1      extends NDefaultInstructionField   // Custom: use rs1(m. idx)
...
// yookyung_generate
object IsVRoPE           extends NDefaultInstructionField   // Custom: vfrope tag
