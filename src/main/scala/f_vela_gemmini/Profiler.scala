...
class ProfileIO[T <: Data]( // fixed by woojin
  cmd_t: T,
  ROB_ID_WIDTH: Int,
  EVENT_ID_WIDTH: Int // EVENT_ID_WIDTH: Int = ROB_ID_WIDTH --> Scala version error: "class ProfileIO takes 3 type parameters but 2 were given" --- IGNORE ---
) extends Bundle {
