error id: file://<WORKSPACE>/Saturn/scala/insns/Instructions.scala:`<none>`.
file://<WORKSPACE>/Saturn/scala/insns/Instructions.scala
empty definition using pc, found symbol in pc: `<none>`.
semanticdb not found

found definition using fallback; symbol OPMFunct6
offset: 15486
uri: file://<WORKSPACE>/Saturn/scala/insns/Instructions.scala
text:
```scala
...
object ID        extends VectorInstruction { val props = Seq(F6(O@@PMFunct6.munary0)  , F3(VectorConsts.OPMVV), RS1(17.U(5.W)), ReadsVS2AsMask.Y, ReadsVS2.N) }
