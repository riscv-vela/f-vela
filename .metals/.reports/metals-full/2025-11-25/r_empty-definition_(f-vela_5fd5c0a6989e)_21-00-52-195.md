error id: file://<WORKSPACE>/Saturn/scala/backend/CustomSequencer.scala:`<none>`.
file://<WORKSPACE>/Saturn/scala/backend/CustomSequencer.scala
...
non-local guesses:
	 ...
	 -scala/Predef.`!`().
offset: 12218
uri: file://<WORKSPACE>/Saturn/scala/backend/CustomSequencer.scala
text:
```scala
